...
<script type="text/javascript">
    ...
    function deleteGoods(){
        ...
        if (items==0) {
            ...
            if(confirm('您确定要删除吗?')){
                $("#form_list").attr("action",APP_BASE+"/doc/api/docentity/delDoc");
                $('#form_list').submit();
            }
        }
    }
    ...
    <div class="fixed-bar">
        <div class="item-title">
            ...
            <ul class="tab-base">
                ...
                <li><a href="${base}/doc/api/docentity/add" ><span>新增</span></a></li>
            </ul>
        </div>
    </div>
    <div class="fixed-empty"></div>
    <form method="post" name="formSearch" id="formSearch" action="${base}/doc/api/docentity/list">
    ...
    <form method='post' id="form_list" >
        ...
        <table class="table tb-type2">
            ...
            <tr class="hover edit">
                ...
                <td align="left">
                	<p>
                		<a href="${base}/doc/api/docentity/findById?id=${data.id}" title="修改">修改</a>&nbsp;&nbsp;
                		<a href="${base}/doc/api/docentity/delDoc?ids=${data.id}" title="删除">删除</a>&nbsp;&nbsp;
                		<a href="${base}/doc/api/docentitypro/list?entityid=${data.id}" title="删除">查看属性</a>&nbsp;&nbsp;
                	</p>
                 </td>
            </tr>
