        ...
        <dd>
            ...
            <ul class="dialog-goodslist-s1 goods-list">
               <#list vo.goodsList as goods>
                       ...
                       <li id="select_recommend_recommend_show_goods_${goods.goodsId}">
                       <div ondblclick="del_recommend_goods(${goods.goodsId});" class="goods-pic">
                       <span class="ac-ico" onclick="del_recommend_goods(${goods.goodsId});"></span>
                       <span class="thumb size-72x72"><i></i><img select_goods_id="${goods.goodsId}" title="${goods.goodsName}" src="${imgServer}${goods.goodsImage}" 
                       onload="javascript:DrawImage(this,72,72);" width="72" height="72"></span>
                       </div><div class="goods-name">
                       <a href="${base}/product/detail?id=${goods.goodsId}" target="_blank">${goods.goodsName}</a></div>
                       <input id="goodsId" value="${goods.goodsId}" type="hidden">
                       <input id="goodsMarketprice" value="${goods.goodsMarketprice}" type="hidden">
                       <input id="goodsName1" value="${goods.goodsName}" type="hidden">
                       <input id="goodsPrice" value="${goods.goodsPrice}" type="hidden">
                       <input id="goodPic" value="${goods.goodsImage}" type="hidden">
