...
<div class="page">
    ...
    <form id="spec_form" method="post" action="${base}/doc/api/saveOrUpdate?pid=${pid}">
        ...
        <table class="table tb-type2">
            ...
            <tr class="noborder">
                <td class="vatop rowform"><input type="text" class="txt" name="tag" id="tag" /></td>
            ...
            <tr class="noborder">
                <td class="vatop rowform"><input type="text" class="txt" name="apiAddress" id="apiAddress" /></td>
            ...
            <tr class="noborder">
                <td class="vatop rowform">
                	<textarea name="returnExampleValue" style="height:100px;"></textarea>
                </td>
