        ...
        <tbody>
	        ...
	        <tr class="noborder">
	            <td class="vatop rowform">
					${advPosition.apName}
					<input name="apId" value="${advPosition.apId}" type="hidden">		
				</td>
	      ...
	      <tr>
	        ...
	        <tr class="noborder">
	            <td class="vatop rowform">
					<input type='hidden' name='resUrl' id="resUrl" value="${adv.resUrl}" class='type-file-text' />
	               	...
	               	<#if (adv.resUrl != '')>
	               		<img id="resUrl" name="resUrl" width="600px" src="${imgServer}${adv.resUrl}">
	               	<#else>
	       ...
	       <tr>
	        ...
	        <tr class="noborder">
	            <td class="vatop rowform"><input type="text" class="txt Wdate" value="${adv.startDateStr}" name="startTime" id="startTime"  onClick="WdatePicker({skin:'twoer',dateFmt:'yyyy-MM-dd HH:mm:ss'});" ></td>
	           <td class="vatop tips"></td>
	        </tr>
	       ...
	       <tr>
	        ...
	        <tr class="noborder">
	            <td class="vatop rowform">
	            	<input type="text" class="txt Wdate" name="endTime" id="endTime" value="${adv.endDateStr}" onClick="WdatePicker({skin:'twoer',dateFmt:'yyyy-MM-dd HH:mm:ss'});">
	            </td>
	            <td class="vatop tips"></td>
	        </tr>
	        ...
	        <tr class="noborder">
	            <td class="vatop rowform"><input type="text" value="255" name="sort" value="${adv.sort}" id="sort" class="txt"></td>
	            <td class="vatop tips"></td>
	        </tr>
