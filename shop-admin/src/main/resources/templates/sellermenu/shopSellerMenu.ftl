...
<div class="fixed-bar">
    <div class="item-title">
        ...
        <ul class="tab-base">
            ...
            <li><a href="${base}/shopSellerMenu/forward" class="current"><span>新增</span></a></li>
        </ul>
    </div>
</div>
...
<form id="shopSellerMenu_form" action="${base}/shopSellerMenu/saveOrUpdate" method="post">
    ...
    <table class="table tb-type2" style="width:auto;">
        <tbody>
	        ...
	        <tr class="noborder">
	            <td class="vatop rowform"><input type="text" value="${shopSellerMenu.menuName}" name="menuName" id="menuName" maxlength="20" class="txt"></td>
	        ...
	        <tr class="noborder">
	            <td class="vatop rowform"><input type="text" value="${shopSellerMenu.menuUrl}" name="menuUrl" id="menuUrl" class="txt"></td>
	            <td class="vatop tips"></td>
	        </tr>
	        ...
	        <tr>
     		...
     		<tr class="noborder">
            	<td class="vatop rowform"><input type="text" value="${shopSellerMenu.menuDescription}" name="mDescription" id="mDescription" class="txt"></td>
        	</tr>
	        <tr>
	        ...
	        <tr class="noborder">
	            <td class="vatop rowform">
		            <input type="radio"  name="menuIsshow" value="1" <#if 1 == shopSellerMenu.menuIsshow || shopSellerMenu.menuIsshow==null>checked="checked" </#if>>显示
		            <input type="radio"  name="menuIsshow" value="0" <#if 0 == shopSellerMenu.menuIsshow>checked="checked" </#if>>隐藏
	            </td>
	        ...
	        <tr class="noborder">
	            <td class="vatop rowform"><input type="text" value="${shopSellerMenu.menuPermission}" name="menuPermission" id="menuPermission" class="txt"></td>
