...
$(function(){
	$("#confirm_button").click(function(){
		...
		var fmUrl = '${base}/m/authc/buyer/orderRefundAmount';
		$.ajax({
             type: "post",
             url: fmUrl,
             data: {orderId:orderId,buyerMessage:buyerMessage,orderGoodsId:orderGoodsId,goodsImageMore:goodsImageMore,refundAmount:refundAmount},
             dataType: "json",
...
<div class="phone_hd">
	<div style=" width: 10%; float: left;">
 	...
 	<div style=" width: 90%; float: left; text-align: center; line-height: 45px;">
  		<ul>
  			<li class="button-one">
  				<a style="color:#000;" href="${base}/m/authc/buyer/returnOrderIndex?orderGoodsId=${orderGoods.recId}">退货退款</a>
  			</li>
  			<li class="button-two">
  				<a style="color:#ffffff;" href="${base}/m/authc/buyer/orderRefundIndex?orderGoodsId=${orderGoods.recId}">仅退款</a>
  			</li>
  		</ul>
 	</div>
			        ...
			        <div class="dd dd_01">
			         ...
			         <div class="dd dd_01">
						...
						<label>
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							退款金额：&nbsp;
							<input type="text" name="refundAmount" value="${orderGoods.goodsPayPrice}" disabled="true"/>            
				  		</label>
				        </span>
				        <span class="size"> </span>
			         </div>
