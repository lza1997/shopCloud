...
//			graphics.setFont(new Font("Arial Black", Font.ITALIC, 18));
    ...
    public static String generateImageString(HttpServletResponse response,HttpServletRequest request) throws IOException {
        return exctractRandCode();
    }
}
