...
<#assign goodsListTag = newTag("goodsListTag")/>
	<div class="phone_hd"><a class="back" href="javascript:history.go(-1);"><img src="${base}/res/html5/images/back.png" width="25" height="25" /></a>店铺商品列表<a class="menu home" href="${base}/m/index/index"><img src="${base}/res/html5/images/home.png" width="25" height="25" /></a></div>
	<div class="main">
  	<#--<div class="mt50"></div>-->
  	<#--
  	<div class="group_top">
		...
		<div id="scroller">
			...
			<div class="group_list" id="thelist"> 
							  ...
							  <#if goodsList?exists && goodsList?size gt 0>
							      <#list goodsList as recommendgoods>
