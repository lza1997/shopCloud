...
<div class="body-box">
	...
	<form id="jvForm" action="o_ajaxUpdate" labelWidth="15" onsubmit="ajaxSubmit();return false;">
		<div style="padding-bottom: 29px; padding-top: 34px;"> <label>文件名</label>
		<input type="text" value="${template.filename}" readonly="readonly" size="40" class="disabled"/>
