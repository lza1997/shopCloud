...
<div class="page">
    ...
    <form id="spec_form" method="post" action="${base}/doc/api/param/saveOrUpdate?docid=${docid}">
        <table class="table tb-type2">
            ...
            <tr class="noborder">
                <td class="vatop rowform">
                	<input type="radio" name="type" id="type" value="1" checked/>String
                	<input type="radio" name="type" id="type"  value="0"/>Integer
                </td>
            ...
            <tr class="noborder">
                <td class="vatop rowform"><input type="text" class="txt" name="exampleValue" id="exampleValue" /></td>
            ...
            <tr class="noborder">
                <td class="vatop rowform"><input type="text" class="txt" name="defalutValue" id="defalutValue" /></td>
