...
<div class="page">
    <div class="fixed-bar">
        <div class="item-title">
            <h3>引用实体管理</h3>
            <ul class="tab-base">
                <li><a href="${base}/doc/api/docentitypro/list?entityid=${entityid}"><span>列表</span></a></li>
    ...
    <form id="spec_form" method="post" action="${base}/doc/api/docentitypro/saveOrUpdate">
        ...
        <table class="table tb-type2">
            ...
            <tr class="noborder">
                <td class="vatop rowform"><input type="text" class="txt" name="type" id="type" /></td>
            ...
            <tr class="noborder">
                ...
                <td class="vatop tips">请填写说明信息</td>
            </tr>
            </tbody>
            <tfoot>
            <tr class="tfoot">
