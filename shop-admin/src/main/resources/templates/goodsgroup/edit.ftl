        ...
        <tbody>
	        ...
	        <tr class="noborder">
	            <td class="vatop rowform">
					 <input type="text"  name="recommendName" id="recommendName" maxlength="100" class="txt" value="${goodsRecommend.recommendName}">	
				</td>
	        ...
	        <tr class="noborder">
	            <td class="vatop rowform">
	              <textarea rows="8" cols="2" name="recommendInfo">${goodsRecommend.recommendInfo}</textarea>
	            </td>
	            <td class="vatop tips"></td>
	        </tr>
	      <tr>
	        ...
	        <tr class="noborder">
                <td class="vatop rowform onoff">
                    <label for="recommendUse1" class="cb-enable  <#if goodsRecommend.recommendUse ??&&  goodsRecommend.recommendUse==1>selected </#if>"><span>启用</span></label>
                    <label for="recommendUse0" class="cb-disable <#if goodsRecommend.recommendUse ??&&  goodsRecommend.recommendUse==0>selected </#if>"><span>停用</span></label>
                    <input id="recommendUse1" name="recommendUse"  value="1" type="radio" <#if goodsRecommend.recommendUse ??&& goodsRecommend.recommendUse==1>checked="checked" </#if>>
                    <input id="recommendUse0" name="recommendUse" value="0" type="radio" <#if goodsRecommend.recommendUse ??&& goodsRecommend.recommendUse==o>checked="checked" </#if>></td>
                </td>
                <td class="vatop tips"></td>
	        </tr>
        </tbody>
