...
<form id="shopPMansong_form" action="${base}/noPost/saveOrUpdate" method="post">
    <input type="hidden" name="id" value="${shopPMansong.id}">
        ...
        <tbody>
	        ...
	        <tr>
                ...
                <td class="vatop rowform onoff">
	                <label for="store_AllowState1" class="cb-enable <#if shopPMansong.npstate == 2>selected</#if>" ><span>通过</span></label>
	                <label for="store_AllowState0" class="cb-disable <#if shopPMansong.npstate == 1>selected</#if>" ><span>不通过</span></label>
	                <input id="store_AllowState1" name="npstate" <#if shopPMansong.npstate == 2>checked="checked"</#if>value="2" type="radio"/>
	                <input id="store_AllowState0" name="npstate" <#if shopPMansong.npstate == 1>checked="checked"</#if>value="1" type="radio"/>
	            </td>
            </tr>
        </tbody>
        <tfoot>
