...
<form id="adv_position_form" action="${base}/advPosition/saveOrUpdate" method="post">
    ...
    <table class="table tb-type2">
        <tbody>
	        ...
	        <tr class="noborder">
	            <td class="vatop rowform">启用：<input type="radio" value="1" name="isUse" id="isUse" class="radio" <#if (advPosition.isUse=1)>checked</#if>>
	            停用：<input type="radio" value="0" name="isUse" id="isUse" class="radio" <#if (advPosition.isUse=0)>checked</#if>></td>
	            <td class="vatop tips"></td>
	        </tr>
