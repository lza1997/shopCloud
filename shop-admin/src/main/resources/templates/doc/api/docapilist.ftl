...
<div class="page">
    ...
    <form method="post" name="formSearch" id="formSearch" action="${base}/doc/api/list?pid=${pid}">
    ...
    <form method='post' id="form_list" >
        ...
        <table class="table tb-type2">
            ...
            <tr class="hover edit">
                ...
                <td align="left">
                	<p>
                		<a href="${base}/doc/api/findById?id=${data.id}&pid=${pid}" title="修改">修改</a>&nbsp;&nbsp;
                		<a href="${base}/doc/api/delDoc?ids=${data.id}" title="删除">删除</a>&nbsp;&nbsp;
                		<a href="${base}/doc/api/param/list?docid=${data.id}" title="API列表">输入参数</a>&nbsp;&nbsp;
                		<a href="${base}/doc/api/returnvalue/list?docid=${data.id}" title="API列表">返回结果</a>&nbsp;&nbsp;
                	</p>
                 </td>
            </tr>
