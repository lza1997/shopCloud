...
<div class="page">
    ...
    <form id="class_form" method="post" action="${base}/couponclass/saveOrUpdate">
        <input type="hidden" name="classId" value="${couponclass.classId}"/>
        <table class="table tb-type2">
            ...
            <tr class="noborder">
                <td class="vatop rowform"><input type="text" class="txt" name="className" id="className" value="${couponclass.className}"/></td>
            ...
            <tr class="noborder">
                <td class="vatop rowform"><input type="text" class="txt" name="classSort" id="classSort" value="${couponclass.classSort}" /></td>
            ...
            <tr class="noborder">
                <td class="vatop rowform">
                	<input type="radio" name="classShow" value="0" <#if couponclass.classShow == '0'>checked</#if> />显示
                	<input type="radio" name="classShow" value="1" <#if couponclass.classShow == '1'>checked</#if>/>不显示
                </td>
